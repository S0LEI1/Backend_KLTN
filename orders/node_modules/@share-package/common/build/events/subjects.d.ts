export declare enum Subjects {
    ...
    PackageServiceUpdated = "package-service:updated",
    ...
    UserShiftCreated = "user-shift:created",
    UserShiftUpdated = "user-shift:updated",
    UserShiftDeleted = "user-shift:deleted",
    BranchCreated = "branch:created",
    BranchUpdated = "branch:updated",
    BranchDeleted = "branch:deleted",
    OrderServiceCreated = "order-service:created",
    OrderServiceUpdated = "order-service:updated",
    OrderServiceDeleted = "order-service:deleted",
    OrderPackageCreated = "order-package:created",
    OrderPackageUpdated = "order-package:updated",
    OrderPackageDeleted = "order-package:deleted",
